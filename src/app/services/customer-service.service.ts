...
const URL = "http://localhost:8086/tmf-api/customerManagement/v4/customer";
...
export class CustomerServiceService {
  ...
  public getCustomerList(): Observable<any> {
     const url = URL+'?offset=1&limit=1000000000';
  ...
  public queryCustomer(param): Observable<any> {
    ...
    const url = URL + '?' + param + '&offset=1&limit=1000000000';
    return this.http.get<any>(url).pipe(
      tap(() => console.log('fetched data')),
    );
  }
